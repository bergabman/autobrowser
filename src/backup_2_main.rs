...
fn main() {
    ...
    let ffox_path = image::open("C:\\rust\\autobrowser\\ffox_new.png").expect("Cant open home_button.png");
    let home_button_path = image::open("C:\\rust\\autobrowser\\home_button.png").expect("Cant open ffox.png");
    let vscode_path = image::open("C:\\rust\\autobrowser\\vscode2.png").expect("Cant open home_button.png");
    let goto_path = image::open("C:\\rust\\autobrowser\\goto.png").expect("Cant open home_button.png");
    let newtab_path = image::open("C:\\rust\\autobrowser\\newtab.png").expect("Cant open home_button.png");
    let login_path = image::open("C:\\rust\\autobrowser\\login.png").expect("Cant open home_button.png");
    let loginbutton_path = image::open("C:\\rust\\autobrowser\\loginbutton.png").expect("Cant open home_button.png");
    let upvotebutton_path = image::open("C:\\rust\\autobrowser\\upvote.png").expect("Cant open home_button.png");
    let newposts_path = image::open("C:\\rust\\autobrowser\\newposts.png").expect("Cant open home_button.png");
    ...
    let vscode = autopilot::bitmap::Bitmap::new(vscode_path, Some(1 as f64));
    ...
    let pos_ffox = screenshot.find_bitmap(&ffox, None, None, None).unwrap_or(Point::new(0 as f64, 0 as f64));
    println!("{:?}", pos_ffox);
    ...
    let pos_newtab = screenshot_1.find_bitmap(&newtab, None, None, None).unwrap_or(Point::new(0 as f64, 0 as f64));
    ...
    let pos_home = screenshot_1.find_bitmap(&home_button, None, None, None).unwrap_or(Point::new(0 as f64, 0 as f64));
    ...
    let pos_goto = screenshot_2.find_bitmap(&goto, None, None, None).unwrap_or(Point::new(0 as f64, 0 as f64));
    ...
    let pos_login = screenshot_3.find_bitmap(&login, None, None, None).unwrap_or(Point::new(0 as f64, 0 as f64));
    ...
    let pos_loginbutton = screenshot_4.find_bitmap(&loginbutton, None, None, None).unwrap_or(Point::new(0 as f64, 0 as f64));
    ...
    let pos_newposts = screenshot_5.find_bitmap(&newposts, None, None, None).unwrap_or(Point::new(0 as f64, 0 as f64));
    ...
    loop {
        ...
        loop {
            ...
            let screenshot_6 = autopilot::bitmap::capture_screen().expect("Unable to capture screen");
            let pos_upvote = screenshot_6.find_bitmap(&upvotebutton, Some(0.1), None, None).unwrap_or(Point::new(0 as f64, 0 as f64));
            ...
            mouse::click(mouse::Button::Left, None);  //click on the position with 100ms
            thread::sleep(time::Duration::from_millis(3000));
            if pos_upvote == Point::new(0 as f64, 0 as f64) {
                break
            }
            mouse::smooth_move(Point::new(1200 as f64, 600 as f64), Some(0.1 as f64)).expect("Unable to move mouse");
            autopilot::mouse::scroll(autopilot::mouse::ScrollDirection::Down, 3);
        ...
        let screenshot_7 = autopilot::bitmap::capture_screen().expect("Unable to capture screen");
        let pos_newposts = screenshot_7.find_bitmap(&newposts, None, None, None).unwrap_or(Point::new(0 as f64, 0 as f64));
        let pos_newposts_new = Point::new(pos_newposts.x + 5 as f64, pos_newposts.y + 5 as f64);
        mouse::smooth_move(pos_newposts_new, Some(0.01 as f64)).expect("Unable to move mouse");
        mouse::click(mouse::Button::Left, None);  //click on the position with 100ms
        thread::sleep(time::Duration::from_millis(4000));
    ...
    let screenshot_last = autopilot::bitmap::capture_screen().expect("Unable to capture screen");
    let pos_vscode = screenshot_last.find_bitmap(&vscode, None, None, None).unwrap_or(Point::new(0 as f64, 0 as f64));
    mouse::smooth_move(pos_vscode, Some(0.01 as f64)).expect("Unable to move mouse");
    mouse::click(mouse::Button::Left, None);  //click on the position with 100ms
}
